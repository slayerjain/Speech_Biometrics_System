...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "invoiceManager";
    ...
    private static final String KEY_PH_NO = "amount";
    private static final String KEY_Voice_Sample = "Voice Sample";
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_CONTACTS + "("
                ...
                + KEY_PH_NO + " TEXT" + KEY_Voice_Sample + "TEXT" +KEY_Confidence + "INTEGER" +")";
